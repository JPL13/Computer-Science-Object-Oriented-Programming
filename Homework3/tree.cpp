...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
    ...
    if(a1[0]==a2[0])
        count=countIncludes(a1+1, n1-1, a2+1, n2-1)+countIncludes(a1+1, n1-1, a2, n2);
...
// the other elements.
//Upon return, firstNotGreater is set to the
// index of the first element in the rearranged array that is
// <= splitter, or n if there is no such element,
//firstLess is
...
void order(double a[], int n)
{
    ...
    split(a, n, a[n-1], firstNot, firstLess);
